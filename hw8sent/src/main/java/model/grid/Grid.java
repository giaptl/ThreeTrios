...
public class Grid {
  ...
  /** A 2D array of {@link Cell} objects representing the grid. */
  private final Cell[][] cells;
  private final int rows;
  private final int cols;

  /**
   * Constructs a new {@link Grid} with the specified number of rows and columns.
   *
  ...
  /**
   * Initializes the grid by filling it with empty {@link Cell} objects.
   */
