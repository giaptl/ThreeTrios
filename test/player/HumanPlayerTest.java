...
public class HumanPlayerTest {
  ...
  public void setUp() {
    ...
    player = new HumanPlayer("TestPlayer", initialHand);
    System.out.println("This is: " + player.getName());
  }
  ...
  public void testConstructorWithNullName() {
    assertThrows(IllegalArgumentException.class, () -> new HumanPlayer(null, initialHand));
  }
