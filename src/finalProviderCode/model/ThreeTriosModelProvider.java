 ...
 */
public interface ThreeTriosModelProvider extends ReadOnlyThreeTriosModelProvider {
   ...
   */
  void startGame(List<CellInterfaceProvider> deck, CellInterfaceProvider[][] board, boolean shuffle);
   ...
   */
  boolean placeCard(PlayerProvider player, CardProvider card, int row, int col);
   ...
   */
  CardProvider getNextCardForPlayer(PlayerProvider currentPlayer);
}
